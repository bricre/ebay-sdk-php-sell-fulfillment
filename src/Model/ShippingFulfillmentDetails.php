...
class ShippingFulfillmentDetails extends AbstractModel
{
     ...
     * item(s). Technically, the shippingCarrierCode and trackingNumber fields are
     * optional, but generally these fields will be provided if the shipping carrier
     * and tracking number are known. Note: Use the Trading API's GeteBayDetails call
     * to retrieve the latest shipping carrier enumeration values. When making the
     * GeteBayDetails call, include the DetailName field in the request payload and set
     * its value to ShippingCarrierDetails. Each valid shipping carrier enumeration
     * value is returned in a ShippingCarrierDetails.ShippingCarrier field in the
     * response payload.
     *
     * @var string
     */
     ...
     * the accuracy of this number. This field and the shippingCarrierCode field are
     * mutually dependent. If you include one, you must also include the other. Note:
     * If you include trackingNumber (and shippingCarrierCode) in the request, the
     * resulting fulfillment's ID (returned in the HTTP location code) is the tracking
     * number. If you do not include shipment tracking information, the resulting
